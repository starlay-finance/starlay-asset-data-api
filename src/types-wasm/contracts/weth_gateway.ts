...
import { ContractAbi } from '../contract-info/weth_gateway';
import QueryMethods from '../query/weth_gateway';
import BuildExtrinsicMethods from '../build-extrinsic/weth_gateway';
import TxSignAndSendMethods from '../tx-sign-and-send/weth_gateway';
import MixedMethods from '../mixed-methods/weth_gateway';
import EventsClass from '../events/weth_gateway';
