...
import { ContractAbi } from '../contract-info/incentives_controller';
import QueryMethods from '../query/incentives_controller';
import BuildExtrinsicMethods from '../build-extrinsic/incentives_controller';
import TxSignAndSendMethods from '../tx-sign-and-send/incentives_controller';
import MixedMethods from '../mixed-methods/incentives_controller';
import EventsClass from '../events/incentives_controller';
