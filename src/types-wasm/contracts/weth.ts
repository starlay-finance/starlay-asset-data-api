...
import { ContractAbi } from '../contract-info/weth';
import QueryMethods from '../query/weth';
import BuildExtrinsicMethods from '../build-extrinsic/weth';
import TxSignAndSendMethods from '../tx-sign-and-send/weth';
import MixedMethods from '../mixed-methods/weth';
import EventsClass from '../events/weth';
