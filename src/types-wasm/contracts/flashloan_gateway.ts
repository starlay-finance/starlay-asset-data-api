...
import { ContractAbi } from '../contract-info/flashloan_gateway';
import QueryMethods from '../query/flashloan_gateway';
import BuildExtrinsicMethods from '../build-extrinsic/flashloan_gateway';
import TxSignAndSendMethods from '../tx-sign-and-send/flashloan_gateway';
import MixedMethods from '../mixed-methods/flashloan_gateway';
import EventsClass from '../events/flashloan_gateway';
