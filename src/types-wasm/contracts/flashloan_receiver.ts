...
import { ContractAbi } from '../contract-info/flashloan_receiver';
import QueryMethods from '../query/flashloan_receiver';
import BuildExtrinsicMethods from '../build-extrinsic/flashloan_receiver';
import TxSignAndSendMethods from '../tx-sign-and-send/flashloan_receiver';
import MixedMethods from '../mixed-methods/flashloan_receiver';
import EventsClass from '../events/flashloan_receiver';
