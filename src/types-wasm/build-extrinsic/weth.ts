...
export default class Methods {
	...
	*/
	"deposit" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "weth::deposit", [], __options);
	}
	...
	*/
	"withdraw" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "weth::withdraw", [value], __options);
	}
