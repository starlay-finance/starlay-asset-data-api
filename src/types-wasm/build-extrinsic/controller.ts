...
export default class Methods {
	...
	*/
	"redeemVerify" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::redeemVerify", [pool, redeemer, redeemAmount], __options);
	}
	...
	*/
	"supportMarketWithCollateralFactorMantissa" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::supportMarketWithCollateralFactorMantissa", [pool, underlying, collateralFactorMantissa], __options);
	}
	...
	*/
	"flashloanGateway" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::flashloanGateway", [], __options);
	}
	...
	*/
	"setFlashloanGateway" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::setFlashloanGateway", [newFlashloanGateway], __options);
	}
	...
	*/
	"marketOfUnderlying" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::marketOfUnderlying", [underlying], __options);
	}
	...
	*/
	"supportMarket" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::supportMarket", [pool, underlying], __options);
	}
	...
	*/
	"balanceDecreaseAllowed" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::balanceDecreaseAllowed", [poolAttributes, account, amount], __options);
	}
	...
	*/
	"calculateUserAccountData" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "controller::calculateUserAccountData", [account, poolAttributes], __options);
	}
