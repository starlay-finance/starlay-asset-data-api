...
export default class Methods {
	...
	*/
	"supportMarket" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "manager::supportMarket", [pool, underlying], __options);
	}
	...
	*/
	"supportMarketWithCollateralFactorMantissa" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "manager::supportMarketWithCollateralFactorMantissa", [pool, underlying, collateralFactorMantissa], __options);
	}
	...
	*/
	"setFlashloanGateway" (
		...
		return buildSubmittableExtrinsic( this.__apiPromise, this.__nativeContract, "manager::setFlashloanGateway", [newFlashloanGateway], __options);
	}
