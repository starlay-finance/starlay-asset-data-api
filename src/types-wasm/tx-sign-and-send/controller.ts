...
export default class Methods {
	...
	*/
	"flashloanGateway" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "controller::flashloanGateway", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, EVENT_DATA_TYPE_DESCRIPTIONS);
		}, [], __options);
	}
	...
	*/
	"marketOfUnderlying" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "controller::marketOfUnderlying", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, EVENT_DATA_TYPE_DESCRIPTIONS);
		}, [underlying], __options);
	}
	...
	*/
	"balanceDecreaseAllowed" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "controller::balanceDecreaseAllowed", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, EVENT_DATA_TYPE_DESCRIPTIONS);
		}, [poolAttributes, account, amount], __options);
	}
	...
	*/
	"calculateUserAccountData" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "controller::calculateUserAccountData", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, EVENT_DATA_TYPE_DESCRIPTIONS);
		}, [account, poolAttributes], __options);
	}
