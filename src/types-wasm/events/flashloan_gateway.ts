import type * as EventTypes from '../event-types/flashloan_gateway';
...
export default class EventsClass {
	...
	public subscribeOnFlashLoanEvent(callback : (event : EventTypes.FlashLoan) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('FlashLoan', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.FlashLoan);
		};

		return this.__subscribeOnEvent(callbackWrapper, (eventName : string) => eventName == 'FlashLoan');
	}
