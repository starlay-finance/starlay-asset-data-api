...
export interface weth_gateway_Error {
	safeEthTransferFailed ? : null,
	insufficientPayback ? : null,
	wethIsNotSet ? : null,
	pool ? : pool_Error,
	psp22 ? : PSP22Error
}

export class weth_gateway_ErrorBuilder {
	static SafeETHTransferFailed(): weth_gateway_Error {
		return {
			safeEthTransferFailed: null,
		};
	}
	static InsufficientPayback(): weth_gateway_Error {
		return {
			insufficientPayback: null,
		};
	}
	static WethIsNotSet(): weth_gateway_Error {
		return {
			wethIsNotSet: null,
		};
	}
	static Pool(value: pool_Error): weth_gateway_Error {
		return {
			pool: value,
		};
	}
	static PSP22(value: PSP22Error): weth_gateway_Error {
		return {
			psp22: value,
		};
	}
