...
export interface flashloan_gateway_Error {
	inconsistentFlashloanParams ? : null,
...
export class flashloan_gateway_ErrorBuilder {
	static InconsistentFlashloanParams(): flashloan_gateway_Error {
		return {
			inconsistentFlashloanParams: null,
		};
	}
	static InvalidFlashloanExecutorReturn(): flashloan_gateway_Error {
		return {
			invalidFlashloanExecutorReturn: null,
		};
	}
	static MarketNotListed(): flashloan_gateway_Error {
		return {
			marketNotListed: null,
		};
	}
	static ControllerIsNotSet(): flashloan_gateway_Error {
		return {
			controllerIsNotSet: null,
		};
	}
	static PSP22(value: PSP22Error): flashloan_gateway_Error {
		return {
			psp22: value,
		};
	}
	static Pool(value: pool_Error): flashloan_gateway_Error {
		return {
			pool: value,
		};
	}
