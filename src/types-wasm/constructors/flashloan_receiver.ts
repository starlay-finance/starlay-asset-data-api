...
import { ContractFile } from '../contract-info/flashloan_receiver';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId } flashloanGateway,
	*/
   	async "new" (
		flashloanGateway: ArgumentTypes.AccountId,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, flashloanGateway);
			let response;
