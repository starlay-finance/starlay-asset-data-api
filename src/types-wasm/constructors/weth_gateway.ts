...
import { ContractFile } from '../contract-info/weth_gateway';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId } weth,
	*/
   	async "new" (
		weth: ArgumentTypes.AccountId,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, weth);
			let response;
