...
export default class Methods {
	...
	*/
	"poolMetadataAll" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "poolMetadataAll", [pools], __options , (result) => { return handleReturnType(result, getTypeDescription(19, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"poolBalances" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "poolBalances", [pool, account], __options , (result) => { return handleReturnType(result, getTypeDescription(21, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"poolBalancesAll" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "poolBalancesAll", [pools, account], __options , (result) => { return handleReturnType(result, getTypeDescription(23, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"underlyingBalance" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "underlyingBalance", [pool, account], __options , (result) => { return handleReturnType(result, getTypeDescription(25, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"underlyingBalanceAll" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "underlyingBalanceAll", [pools, account], __options , (result) => { return handleReturnType(result, getTypeDescription(26, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"poolUnderlyingPrice" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "poolUnderlyingPrice", [pool], __options , (result) => { return handleReturnType(result, getTypeDescription(28, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"poolUnderlyingPriceAll" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "poolUnderlyingPriceAll", [pools], __options , (result) => { return handleReturnType(result, getTypeDescription(30, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"configuration" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "configuration", [controller], __options , (result) => { return handleReturnType(result, getTypeDescription(32, DATA_TYPE_DESCRIPTIONS)); });
	}
