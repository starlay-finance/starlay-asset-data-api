...
export default class Methods {
	...
	*/
	"redeemVerify" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::redeemVerify", [pool, redeemer, redeemAmount], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"supportMarketWithCollateralFactorMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::supportMarketWithCollateralFactorMantissa", [pool, underlying, collateralFactorMantissa], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"seizeGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::seizeGuardianPaused", [], __options , (result) => { return handleReturnType(result, getTypeDescription(24, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"borrowAllowed" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::borrowAllowed", [pool, borrower, borrowAmount, poolAttribute], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"liquidationIncentiveMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::liquidationIncentiveMantissa", [], __options , (result) => { return handleReturnType(result, getTypeDescription(27, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"manager" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::manager", [], __options , (result) => { return handleReturnType(result, getTypeDescription(28, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"flashloanGateway" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::flashloanGateway", [], __options , (result) => { return handleReturnType(result, getTypeDescription(28, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"redeemAllowed" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::redeemAllowed", [pool, redeemer, redeemAmount, poolAttribute], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"borrowCap" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::borrowCap", [pool], __options , (result) => { return handleReturnType(result, getTypeDescription(31, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"setFlashloanGateway" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::setFlashloanGateway", [newFlashloanGateway], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"marketOfUnderlying" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::marketOfUnderlying", [underlying], __options , (result) => { return handleReturnType(result, getTypeDescription(28, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"getAccountLiquidity" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::getAccountLiquidity", [account], __options , (result) => { return handleReturnType(result, getTypeDescription(33, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"transferAllowed" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::transferAllowed", [pool, src, dst, transferTokens, poolAttribute], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"closeFactorMantissa" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::closeFactorMantissa", [], __options , (result) => { return handleReturnType(result, getTypeDescription(27, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"getHypotheticalAccountLiquidity" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::getHypotheticalAccountLiquidity", [account, token, redeemTokens, borrowAmount], __options , (result) => { return handleReturnType(result, getTypeDescription(33, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"supportMarket" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::supportMarket", [pool, underlying], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"oracle" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::oracle", [], __options , (result) => { return handleReturnType(result, getTypeDescription(28, DATA_TYPE_DESCRIPTIONS)); });
	}

	/**
	* balanceDecreaseAllowed
	*
	* @param { ArgumentTypes.PoolAttributesForWithdrawValidation } poolAttributes,
	* @param { ArgumentTypes.AccountId } account,
	* @param { (string | number | BN) } amount,
	* @returns { Result<Result<boolean, ReturnTypes.Error>, ReturnTypes.LangError> }
	*/
	"balanceDecreaseAllowed" (
		poolAttributes: ArgumentTypes.PoolAttributesForWithdrawValidation,
		account: ArgumentTypes.AccountId,
		amount: (string | number | BN),
		__options ? : GasLimit,
	): Promise< QueryReturnType< Result<Result<boolean, ReturnTypes.Error>, ReturnTypes.LangError> > >{
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::balanceDecreaseAllowed", [poolAttributes, account, amount], __options , (result) => { return handleReturnType(result, getTypeDescription(37, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*
	* @param { ArgumentTypes.AccountId } account,
	* @param { ArgumentTypes.PoolAttributesForWithdrawValidation | null } poolAttributes,
	* @returns { Result<Result<ReturnTypes.AccountData, ReturnTypes.Error>, ReturnTypes.LangError> }
	*/
	"calculateUserAccountData" (
		account: ArgumentTypes.AccountId,
		poolAttributes: ArgumentTypes.PoolAttributesForWithdrawValidation | null,
		__options ? : GasLimit,
	): Promise< QueryReturnType< Result<Result<ReturnTypes.AccountData, ReturnTypes.Error>, ReturnTypes.LangError> > >{
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::calculateUserAccountData", [account, poolAttributes], __options , (result) => { return handleReturnType(result, getTypeDescription(40, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"transferGuardianPaused" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::transferGuardianPaused", [], __options , (result) => { return handleReturnType(result, getTypeDescription(24, DATA_TYPE_DESCRIPTIONS)); });
	}
	...
	*/
	"liquidateBorrowAllowed" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "controller::liquidateBorrowAllowed", [poolBorrowed, poolCollateral, liquidator, borrower, repayAmount, poolAttribute], __options , (result) => { return handleReturnType(result, getTypeDescription(13, DATA_TYPE_DESCRIPTIONS)); });
	}
